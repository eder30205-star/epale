          ...
          <div style={{display:"flex",gap:12,marginBottom:10}}>
            ...
            <div style={{flex:1}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                <span onClick={function(){ if(props.onOpenProfile) props.onOpenProfile(post.name); }} style={{fontWeight:700,fontSize:15,fontFamily:"'Syne',sans-serif",color:C.text,cursor:"pointer",display:"inline-flex",alignItems:"center",gap:4}}>{post.name}{isFounder(post.name)?<span style={{display:"inline-flex",alignItems:"center",gap:3,background:"linear-gradient(135deg,#ffd700,#ff8c00)",borderRadius:20,padding:"1px 7px",fontSize:10,fontWeight:800,color:"#fff",letterSpacing:0.3}}>{"⚡ Founder"}</span>:isVerified(post.name)?<span style={{display:"inline-flex",alignItems:"center",justifyContent:"center",width:16,height:16,background:C.blue,borderRadius:9999,fontSize:10,color:"#fff",fontWeight:800}}>{"✓"}</span>:null}</span>
