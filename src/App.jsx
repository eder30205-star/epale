...
function Feed(props) {
  ...
  useEffect(function(){
    ...
    var panaHandler=function(){ setShowPana(true); };
    document.addEventListener("epale:openPana",panaHandler);
    return function(){
      document.removeEventListener("epale:openComposer",handler);
      document.removeEventListener("epale:openPana",panaHandler);
    };
  },[]);
