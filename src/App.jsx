...
function Feed(props) {
  ...
  useEffect(function(){
    ...
    window._openPana=function(){ setShowPana(true); };
    return function(){
      document.removeEventListener("epale:openComposer",handler);
      window._openPana=null;
    };
  },[]);
