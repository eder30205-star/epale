...
var api = {
  ...
  likePost: function(uid, postId) {
    return fetchAuth(SUPA_URL+"/rest/v1/likes",{method:"POST",headers:{"Content-Type":"application/json","apikey":SUPA_KEY,"Authorization":"Bearer "+getToken(),"Prefer":"resolution=merge-duplicates,return=representation"},body:JSON.stringify({user_id:uid,post_id:String(postId)})}).then(function(r){return r.json();}).catch(function(){});
  },
  ...
  signInWithGoogle: function() {
    return supabase.auth.signInWithOAuth({
      provider: "google",
      options: { redirectTo: "https://epaleapp.online" }
    });
  },
...
const SEED=[
  {id:101,city:"madrid",type:"post",name:"Carlos Useche",av:"CU",content:"epale!! acabo de instalar esto y ya veo como 10 conocidos mios aqui jajaja el mundillo venezolano es pequeñisimo 😂",likes:12,comments:4,time:"12min",_comments:[
  ...
  {id:102,city:"madrid",type:"post",name:"Andreina C",av:"AC",content:"alguien sabe si hay venezolanos por la zona de vallecas? llevo 8 meses aqui y todavia no he encontrado casi nadie de venezuela cerca",likes:5,comments:3,time:"28min",_comments:[
  ...
  {id:103,city:"madrid",type:"post",name:"Luis G",av:"LG",content:"que fue?? esto es como un twitter pero venezolano?? ya lo compartí en el grupo del trabajo a ver cuantos se meten jajaja",likes:23,comments:3,time:"45min",_comments:[
  ...
  {id:104,city:"madrid",type:"post",name:"Maria Fernanda",av:"MF",content:"3 años en madrid y todavia cuando huelo caraotas me da un ataque de nostalgia terrible. alguien mas o solo yo?? 😭",likes:67,comments:4,time:"1h",_comments:[
  ...
  {id:105,city:"madrid",type:"post",name:"Katiuska B",av:"KB",content:"oe alguien puede explicarme como funciona lo de los paises? puedo ver lo que publican en miami tambien o solo veo españa?",likes:3,comments:3,time:"2h",_comments:[
  ...
  {id:201,city:"miami",type:"post",name:"Valentina R",av:"VR",content:"5 años aqui y sigo llorando con el himno nacional. no se si eso es bueno o malo pero no lo puedo evitar 😅🇻🇪",likes:89,comments:4,time:"8min",_comments:[
  ...
  {id:202,city:"miami",type:"post",name:"Andres M",av:"AM",content:"doral es literalmente venezuela norte. hoy desayune arepas, almorcé pabellon y cené tequeños. sin salir del condado 😂",likes:134,comments:4,time:"22min",_comments:[
  ...
  {id:203,city:"miami",type:"post",name:"Paty G",av:"PG",content:"hola!! soy nueva aqui. alguien me puede recomendar grupos o gente interesante pa seguir? llegue hace 4 meses a miami y todavia estoy ubicandome",likes:8,comments:3,time:"1h",_comments:[
  ...
  {id:204,city:"miami",type:"post",name:"Jorge L",av:"JL",content:"oye esto esta buenisimo. ya lo mande al grupo de venezolanos del building y en 10 minutos ya habian 6 registrados jajaja somos asi",likes:45,comments:3,time:"3h",_comments:[
  ...
  {id:205,city:"miami",type:"post",name:"Gaby F",av:"GF",content:"extraño venezuela todos los dias. pero tambien ya no me imagino viviendo sin la seguridad de aqui. es una contradiccion con la que uno aprende a vivir",likes:178,comments:4,time:"5h",_comments:[
  ...
  {id:301,city:"bogota",type:"post",name:"Nelson B",av:"NB",content:"4 años en bogota y puedo decir con propiedad: los colombianos son lo maximo. nos han recibido increible. gracias colombia 🇨🇴❤️",likes:56,comments:3,time:"15min",_comments:[
  ...
  {id:302,city:"bogota",type:"post",name:"Diana M",av:"DM",content:"me acabo de enterar que hay mas de 500mil venezolanos en colombia. QUINIENTOS MIL. eso es una ciudad entera. y no nos conocemos entre nosotros??",likes:234,comments:3,time:"40min",_comments:[
  ...
  {id:303,city:"bogota",type:"post",name:"Luisa Ma",av:"LM",content:"pregunta pa los que llevan tiempo: como hicieron pa conseguir el primer trabajo aqui? estoy llegando la semana que viene y estoy un poco perdida",likes:19,comments:3,time:"2h",_comments:[
  ...
  {id:304,city:"bogota",type:"post",name:"Rafa T",av:"RT",content:"que chimbo el frio de bogota al principio jajaja vine de maracaibo con ropa de playa y casi me muero. ya me adapte pero uff",likes:78,comments:2,time:"4h",_comments:[
  ...
  {id:401,city:"santiago",type:"post",name:"Raul J",av:"RJ",content:"me dieron la residencia definitiva. llore. de verdad. despues de 3 años de tramites y papeles y idas y venidas. ya soy residente definitivo en chile 🥹",likes:312,comments:4,time:"20min",_comments:[
  ...
  {id:402,city:"santiago",type:"post",name:"Nathaly G",av:"NG",content:"alguien mas piensa que el acento chileno es el mas dificil de entender al principio?? yo dure meses sin entender nada jajajaja",likes:145,comments:3,time:"1h",_comments:[
  ...
  {id:403,city:"santiago",type:"post",name:"Pedro A",av:"PA",content:"oye pregunta para los de miami: como esta la cosa por alla? estoy evaluando opciones y tengo familia alla. cualquier info sirve",likes:11,comments:2,time:"3h",_comments:[
  ...
  {id:501,city:"lima",type:"post",name:"Rafael M",av:"RM",content:"3 años en lima. la ciudad mas caótica que he vivido y al mismo tiempo la que mas me ha enseñado. rara la vida 🇵🇪",likes:34,comments:3,time:"30min",_comments:[
  ...
  {id:502,city:"lima",type:"post",name:"Simon P",av:"SP",content:"esta app la necesitaba. eso es todo. nos vemos por aca 👋",likes:67,comments:2,time:"2h",_comments:[
  ...
  {id:503,city:"lima",type:"post",name:"Caro V",av:"CV",content:"llegue hace 2 semanas. alguien que lleve tiempo en lima me puede decir cuales son las zonas mas tranquilas pa vivir? gracias de antemano",likes:7,comments:3,time:"4h",_comments:[
  ...
  {id:601,city:"buenos",type:"post",name:"Gabi C",av:"GC",content:"vivir en un pais con inflacion siendo venezolano es una experiencia... unica. ya sabes como funciona esto. te adaptas rapido jajaja 😂🇦🇷",likes:189,comments:3,time:"1h",_comments:[
  ...
  {id:602,city:"buenos",type:"post",name:"Eduardo V",av:"EV",content:"el mate me costo horrores acostumbrarme. amargo, caliente, sin azucar. pero ya no puedo vivir sin el. la integracion tiene sus ventajas 🧉",likes:98,comments:2,time:"3h",_comments:[
  ...
  {id:701,city:"quito",type:"post",name:"Luisa F",av:"LF",content:"quito a 2800 metros sobre el nivel del mar. llegue y no podia ni caminar rapido sin que me faltara el aire. a los 3 meses ya subia cerros. el cuerpo todo lo puede 💪",likes:45,comments:2,time:"2h",_comments:[
  ...
  {id:702,city:"quito",type:"post",name:"Jose H",av:"JH",content:"somos poquitos los venezolanos en ecuador comparado con colombia pero aqui estamos. saludos a todos desde quito 🇪🇨🇻🇪",likes:23,comments:4,time:"5h",_comments:[
  ...
  {id:801,city:"panama",type:"post",name:"Roberto D",av:"RD",content:"panama es chiquito pero tiene de todo. y la comunidad venezolana aqui es muy unida. si llegas aqui busca tu gente que te ayudan",likes:34,comments:2,time:"1h",_comments:[
  ...
  {id:802,city:"panama",type:"post",name:"Carmen B",av:"CB",content:"nueva en la app!! alguien me puede explicar como funciona esto de publicar por tipo? para que sirve cada categoria?",likes:6,comments:2,time:"4h",_comments:[
  ...
  {id:901,city:"caracas",type:"post",name:"Maria A",av:"MA",content:"buenos dias desde caracas. el avila amanecio precioso hoy. para los que estan lejos: la ciudad sigue siendo bella. los queremos mucho desde aqui 🏔️",likes:445,comments:3,time:"2h",_comments:[
  ...
  {id:902,city:"caracas",type:"post",name:"Daniela S",av:"DS",content:"que chimbo y que bonito a la vez ver a venezolanos en todo el mundo. orgullosa de nuestra gente aunque las circunstancias sean las que son 🥺❤️",likes:567,comments:2,time:"5h",_comments:[
  ...
  {id:903,city:"caracas",type:"post",name:"Luis M",av:"LM",content:"pregunta pa los de afuera: extrañan mas la comida, la familia o el clima? yo digo que extrañan las tres pero cual mas?",likes:678,comments:3,time:"8h",_comments:[
  ...
  {id:1001,city:"portugal",type:"post",name:"Carlos V",av:"CV",content:"lisboa es increible. los portugueses tienen algo especial. y el idioma se aprende rapido si eres venezolano. somos muy parecidos 🇵🇹",likes:34,comments:2,time:"3h",_comments:[
  ...
  {id:1002,city:"portugal",type:"post",name:"Isabel R",av:"IR",content:"6 meses en portugal y todavia me pierdo en el metro de lisboa jajaja alguien mas o solo yo?? 😅",likes:19,comments:2,time:"7h",_comments:[
  ...
  {id:1101,city:"italia",type:"post",name:"Sofia M",av:"SM",content:"llegue a roma sin saber una palabra de italiano. hoy me defiendo. el cerebro venezolano se adapta a todo jajaja 🇮🇹🇻🇪",likes:45,comments:3,time:"4h",_comments:[
  ...
  {id:1102,city:"italia",type:"post",name:"Marco V",av:"MV",content:"venezolanos en italia donde estan?? yo en milan hace 2 años y somos poquitos pero aqui estamos. saludense 👋",likes:12,comments:3,time:"9h",_comments:[
  ...
  {id:1201,city:"canada",type:"post",name:"Pedro M",av:"PM",content:"menos 20 grados ayer en toronto. MENOS VEINTE. yo que soy de maracaibo. todavia no entiendo como sobrevivo esto cada invierno 😂❄️🇨🇦",likes:56,comments:3,time:"3h",_comments:[
  ...
  {id:1202,city:"canada",type:"post",name:"Ana R",av:"AR",content:"recien llegada a vancouver. buscando venezolanos por la costa oeste de canada. hay alguien por aqui??",likes:8,comments:2,time:"7h",_comments:[
    ...
    <div style={{position:"fixed",bottom:0,left:0,right:0,zIndex:500,background:C.card,borderRadius:"20px 20px 0 0",boxShadow:"0 -4px 24px rgba(0,0,0,0.2)",overflow:"hidden",maxHeight:"50vh",display:"flex",flexDirection:"column"}}>
      ...
      {!search&&<div style={{display:"flex",overflowX:"auto",borderBottom:"1px solid "+C.border,scrollbarWidth:"none"}}>
        {EMOJI_CATS.map(function(k){
          var icon=k.split(" ")[0];
          return <button key={k} onClick={function(){setCat(k);}} style={{padding:"8px 12px",background:"none",border:"none",borderBottom:"2px solid "+(cat===k?C.blue:"transparent"),cursor:"pointer",fontSize:16,flexShrink:0,opacity:cat===k?1:0.5,fontFamily:"Segoe UI Emoji, Apple Color Emoji, sans-serif"}}>{icon}</button>;
        })}
      </div>}
      {/* Emoji grid */}
          ...
          <div style={{display:"flex",gap:12,marginBottom:10}}>
            ...
            <div style={{flex:1}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                <span onClick={function(){ if(props.onOpenProfile) props.onOpenProfile(post.name); }} style={{fontWeight:700,fontSize:15,fontFamily:"'Syne',sans-serif",color:C.text,cursor:"pointer",display:"inline-flex",alignItems:"center",gap:4}}>{post.name}{(isFounder(post.name)||isFounder(userName)&&post.name===userName)?<span style={{display:"inline-flex",alignItems:"center",gap:3,background:"linear-gradient(135deg,#ffd700,#ff8c00)",borderRadius:20,padding:"1px 7px",fontSize:10,fontWeight:800,color:"#fff",letterSpacing:0.3}}>{"⚡ Founder"}</span>:(isVerified(post.name))?<span style={{display:"inline-flex",alignItems:"center",justifyContent:"center",width:16,height:16,background:C.blue,borderRadius:9999,fontSize:10,color:"#fff",fontWeight:800}}>{"✓"}</span>:null}</span>
      ...
      {open&&!blocked?(<div style={{borderTop:"1px solid "+C.border,padding:"10px 14px"}}>
        ...
        <div style={{position:"relative"}}>
          ...
          <div style={{display:"flex",gap:8,alignItems:"center",marginTop:4}}>
            <button onClick={function(){setShowCommentEmoji(function(v){return !v;});}} style={{background:"none",border:"none",cursor:"pointer",fontSize:22,padding:"0 4px",flexShrink:0,opacity:0.7,minWidth:36,minHeight:44,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Segoe UI Emoji, Apple Color Emoji, sans-serif"}}>{"😊"}</button>
...
function Feed(props) {
  ...
  var [filter,setFilter]=useState("all"); var [posts,setPosts]=useState(SEED); var [showComposer,setShowComposer]=useState(false); var [showPanaLocal,setShowPanaLocal]=useState(false);
  ...
  useEffect(function(){
    ...
    return function(){
      document.removeEventListener("epale:openComposer",handler);
  ...
  var [memberCount,setMemberCount]=useState(null);
  useEffect(function(){
    fetch(SUPA_URL+"/rest/v1/profiles?select=id",{headers:{"apikey":SUPA_KEY,"Prefer":"count=exact"}})
      .then(function(r){ var count=r.headers.get("content-range"); if(count) setMemberCount(parseInt(count.split("/")[1])||null); })
      .catch(function(){});
  },[]);
  useEffect(function(){
  ...
  var dollarWidget=(<div style={{background:"#0d0d0d",borderRadius:14,overflow:"hidden",marginBottom:16}}>
    ...
    {memberCount?<div style={{padding:"8px 14px",borderTop:"1px solid rgba(255,255,255,0.07)",display:"flex",alignItems:"center",gap:8}}><span style={{fontSize:13}}>{"👥"}</span><span style={{fontSize:12,color:"rgba(255,255,255,0.5)",fontFamily:"'Inter',sans-serif"}}><strong style={{color:"#ffcc00"}}>{memberCount.toLocaleString()}</strong> venezolanos en Epale</span></div>:null}
  ...
  if(showPanaLocal) return <Pana onClose={function(){setShowPanaLocal(false);}}/>;
...
function Composer(props) {
  ...
  return (<div style={{position:"fixed",inset:0,zIndex:200,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:"center",justifyContent:"center"}} onClick={onClose}>
    {showGif&&<GifPicker onSelect={function(gif){ setMedia({src:gif.src,preview:gif.preview,kind:"gif"}); setShowGif(false); }} onClose={function(){setShowGif(false);}}/>}<div onClick={function(e){e.stopPropagation();}} style={{width:"100%",maxWidth:560,background:C.card,borderRadius:22,padding:"0 0 36px",maxHeight:"90vh",overflowY:"auto",margin:"0 16px"}}><div style={{display:"flex",justifyContent:"center",padding:"12px 0 4px"}}><div style={{width:36,height:4,borderRadius:2,background:C.border}}/></div><div style={{padding:"4px 20px 0"}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}><div style={{display:"flex",alignItems:"center",gap:10}}><Av t={userName||"?"} i={0} s={38} photo={userPhoto}/><span style={{fontSize:15,fontFamily:"'Syne',sans-serif",color:C.text,fontWeight:700}}>Nueva publicacion</span></div><button onClick={function(){setShowCityPicker(function(v){return !v;});}} style={{background:C.bg,border:"1.5px solid "+C.border,borderRadius:100,padding:"5px 12px",cursor:"pointer",display:"flex",alignItems:"center",gap:6}}><span style={{fontSize:14}}>{selectedCity==="all"?ICONS.group:toFlag(CITY_FLAGS[selectedCity])}</span><span style={{fontSize:12,color:C.blue,fontFamily:"'Inter',sans-serif",fontWeight:700}}>{selectedCity==="all"?"Todos los paises":selectedCityObj.name}</span><span style={{fontSize:10,color:C.muted}}>{"v"}</span></button></div>{showCityPicker?(<div style={{background:C.bg,borderRadius:14,border:"1px solid "+C.border,padding:"8px",marginBottom:12,display:"flex",flexWrap:"wrap",gap:6}}><button onClick={function(){setSelectedCity("all");setShowCityPicker(false);}} style={{padding:"5px 10px",borderRadius:100,border:"1.5px solid "+(selectedCity==="all"?C.yellow:C.border),background:selectedCity==="all"?C.yellow:C.card,color:C.text,fontFamily:"'Inter',sans-serif",fontSize:11,fontWeight:700,cursor:"pointer"}}>Todos los paises</button>{CITIES.map(function(c){ return (<button key={c.id} onClick={function(){setSelectedCity(c.id);setShowCityPicker(false);}} style={{padding:"5px 10px",borderRadius:100,border:"1.5px solid "+(selectedCity===c.id?C.blue:C.border),background:selectedCity===c.id?C.blue:C.card,color:selectedCity===c.id?"#fff":C.text,fontFamily:"'Inter',sans-serif",fontSize:11,fontWeight:600,cursor:"pointer",display:"flex",alignItems:"center",gap:4}}><span>{toFlag(CITY_FLAGS[c.id])}</span><span>{c.name}</span></button>); })}</div>):null}<div style={{display:"flex",gap:6,marginBottom:14,overflowX:"auto"}}>{Object.entries(TYPES).map(function(entry){ var id=entry[0],m=entry[1]; return <button key={id} onClick={function(){setType(id);}} style={{padding:"5px 12px",borderRadius:20,border:"1.5px solid "+(type===id?C.blue:C.border),background:type===id?C.blue:C.card,color:type===id?"#fff":C.muted,fontFamily:"'Inter',sans-serif",fontSize:11,fontWeight:700,cursor:"pointer",whiteSpace:"nowrap",flexShrink:0}}>{m.icon} {m.label}</button>; })}</div><div style={{position:"relative",marginBottom:12}}>
          ...
          <button onClick={function(){setShowEmoji(function(v){return !v;});}} style={{position:"absolute",bottom:10,right:12,background:"none",border:"none",cursor:"pointer",fontSize:22,opacity:0.7,padding:0,fontFamily:"Segoe UI Emoji, Apple Color Emoji, sans-serif"}}>{"😊"}</button>
              ...
              <div key={u.id||i} onClick={function(){onOpenProfile(u.name);}} style={{display:"flex",alignItems:"center",gap:14,padding:"14px 16px",borderBottom:"1px solid "+C.border,background:C.card,cursor:"pointer"}}>
                ...
                <div style={{flex:1,minWidth:0}}>
                  <div style={{display:"flex",alignItems:"center",gap:4}}>
                    ...
                    {isFounder(u.name)?<span style={{display:"inline-flex",alignItems:"center",gap:3,background:"linear-gradient(135deg,#ffd700,#ff8c00)",borderRadius:20,padding:"1px 7px",fontSize:10,fontWeight:800,color:"#fff"}}>{"⚡"} Founder</span>:isVerified(u.name)?<span style={{display:"inline-flex",alignItems:"center",justifyContent:"center",width:16,height:16,background:C.blue,borderRadius:9999,fontSize:10,color:"#fff",fontWeight:800}}>{"✓"}</span>:null}
                  </div>
                ...
                <div style={{display:"flex",gap:10,marginBottom:8}}>
                  ...
                  <div>
                    <div style={{display:"flex",alignItems:"center",gap:4}}>
                      ...
                      {isFounder(p.name)?<span style={{display:"inline-flex",alignItems:"center",gap:3,background:"linear-gradient(135deg,#ffd700,#ff8c00)",borderRadius:20,padding:"1px 7px",fontSize:10,fontWeight:800,color:"#fff"}}>{"⚡"} Founder</span>:isVerified(p.name)?<span style={{display:"inline-flex",alignItems:"center",justifyContent:"center",width:16,height:16,background:C.blue,borderRadius:9999,fontSize:10,color:"#fff",fontWeight:800}}>{"✓"}</span>:null}
                    </div>
...
function Notificaciones(props) {
  ...
  useEffect(function(){ if(userId){ api.getNotifications(userId).then(function(data){ if(Array.isArray(data)&&data.length>0){ var mapped=data.map(function(n){ var icon=n.type==="like"?ICONS.heart:n.type==="comment"?ICONS.comment:n.type==="welcome"?"🎉":ICONS.flag_ve;
                var text=n.type==="like"?n.from_name+" le dio like a tu post":n.type==="comment"?n.from_name+" comento en tu post":n.type==="welcome"?"Bienvenido a Epale! Conecta con venezolanos en tu pais 🇻🇪":n.from_name; return {id:n.id,icon:icon,iconBg:C.card,text:text,time:formatTime(n.created_at),read:n.read}; }); setNotifs(NOTIF_SEED.concat(mapped)); } setLoading(false); }).catch(function(){ setLoading(false); }); } else { setLoading(false); } },[userId]);
...
function Profile(props) {
  ...
  var TR=T[currentLang]||T.es; var [subScreen,setSubScreen]=useState(null); var cityObj=getCity(userCity||"miami");
  ...
  if(subScreen==="config") return <Configuracion userCity={userCity} onClose={function(){setSubScreen(null);}} onLogout={onLogout} onSetDark={onSetDark} onSetLang={onSetLang} isDark={isDark} currentLang={currentLang} userName={userName} userPhoto={userPhoto} userBio={userBio} onCityChange={props.onCityChange}/>;
  if(subScreen==="edit") return <EditProfile userCity={userCity} userPhoto={userPhoto} userName={userName} userBio={userBio} onPhotoChange={onPhotoChange} onBioChange={onBioChange} onClose={function(){setSubScreen(null);}} onCityChange={props.onCityChange}/>;
  return (
    <div style={{position:"fixed",inset:0,zIndex:200,display:"flex",alignItems:"flex-start",justifyContent:"center",background:"rgba(0,0,0,0.5)",overflowY:"auto",paddingTop:window.innerWidth>=768?"40px":"0"}}><div style={{width:"100%",maxWidth:480,background:C.bg,minHeight:"100vh",position:"relative"}}>
      <div style={{display:"flex",height:4}}><div style={{flex:1,background:C.yellow}}/><div style={{flex:1,background:C.blue}}/><div style={{flex:1,background:C.red}}/></div>
      <div style={{background:C.card,borderBottom:"1px solid "+C.border,marginBottom:10}}>
        ...
        <div style={{padding:"0 20px 20px",position:"relative"}}>
          <div style={{position:"absolute",top:-36,left:20,padding:3,borderRadius:9999,background:C.card}}><Av t={userName} i={0} s={72} photo={userPhoto}/></div>
          <div style={{paddingTop:46,display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
            <div><div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
              ...
              {isFounder(userName)?<span style={{display:"inline-flex",alignItems:"center",gap:3,background:"linear-gradient(135deg,#ffd700,#ff8c00)",borderRadius:20,padding:"3px 10px",fontSize:11,fontWeight:800,color:"#fff"}}>{"⚡ Founder"}</span>:isVerified(userName)?<span style={{display:"inline-flex",alignItems:"center",justifyContent:"center",width:18,height:18,background:C.blue,borderRadius:9999,fontSize:11,color:"#fff",fontWeight:800}}>{"✓"}</span>:null}
            </div>{userBio?<div style={{fontSize:13,color:C.muted,fontFamily:"'Inter',sans-serif",marginTop:4}}>{userBio}</div>:null}<div style={{fontSize:12,color:C.blue,fontFamily:"'Inter',sans-serif",fontWeight:700,marginTop:2}}>{toFlag(CITY_FLAGS[userCity])} {cityObj.name}</div></div>
...
function EditProfile(props) {
  ...
  var [city,setCity]=useState(userCity||"miami");
  ...
  var save=function(){
    ...
    var finish=function(photoUrl){ var finalPhoto=photoUrl||photo; try { var s=localStorage.getItem("epale_session"); var d=s?JSON.parse(s):{}; d.name=name; if(finalPhoto) d.photo=finalPhoto; d.bio=bio; d.city=city; localStorage.setItem("epale_session",JSON.stringify(d)); } catch(e){} setLoading(false); setSaved(true); onPhotoChange(finalPhoto); onBioChange(bio); if(props.onCityChange&&city!==userCity) props.onCityChange(city); setTimeout(onClose,1200); };
    if(uid){ if(photo&&photo.startsWith("data:")){ api.uploadPhoto(uid,photo).then(function(url){ api.updateProfile(uid,name,city,username,url||photo,bio).then(function(){ finish(url||photo); }).catch(function(){ finish(photo); }); }).catch(function(){ api.updateProfile(uid,name,city,username,photo,bio).then(function(){ finish(photo); }).catch(function(){ finish(photo); }); }); } else { api.updateProfile(uid,name,city,username,photo,bio).then(function(){ finish(photo); }).catch(function(){ finish(photo); }); } } else { finish(photo); }
  };
  return (
    <div style={{position:"fixed",inset:0,zIndex:300,background:C.bg,maxWidth:480,margin:"0 auto",overflowY:"auto"}}>
      ...
      <div style={{padding:"24px 20px 60px"}}>
        ...
        <div style={{marginBottom:18}}>
          <div style={{fontSize:10,fontFamily:"'Inter',sans-serif",color:C.muted,marginBottom:7,letterSpacing:1}}>PAIS</div>
          <button onClick={function(){setShowCityPicker(function(v){return !v;});}} style={{width:"100%",padding:"13px 16px",background:C.card,border:"1.5px solid "+(showCityPicker?C.blue:C.border),borderRadius:14,cursor:"pointer",display:"flex",alignItems:"center",gap:12,textAlign:"left"}}>
            <span style={{fontSize:22}}>{toFlag(CITY_FLAGS[city])}</span>
            <div style={{flex:1}}>
              <div style={{fontSize:15,fontFamily:"'Syne',sans-serif",color:C.text,fontWeight:700}}>{getCity(city).name}</div>
              <div style={{fontSize:11,color:C.muted,fontFamily:"'Inter',sans-serif"}}>{getCity(city).pop}</div>
            </div>
            <span style={{color:C.muted,fontSize:14}}>{showCityPicker?"▲":"▼"}</span>
          </button>
          {showCityPicker&&<div style={{marginTop:8,borderRadius:14,border:"1px solid "+C.border,overflow:"hidden",maxHeight:280,overflowY:"auto"}}>
            {CITIES.map(function(c){
              return <button key={c.id} onClick={function(){setCity(c.id);setShowCityPicker(false);}} style={{width:"100%",display:"flex",alignItems:"center",gap:12,padding:"12px 16px",background:city===c.id?C.bg:C.card,border:"none",borderBottom:"1px solid "+C.border,cursor:"pointer",textAlign:"left"}}>
                <span style={{fontSize:20}}>{toFlag(CITY_FLAGS[c.id])}</span>
                <div style={{flex:1}}><div style={{fontSize:14,fontFamily:"'Syne',sans-serif",color:C.text,fontWeight:600}}>{c.name}</div></div>
                {city===c.id?<span style={{color:C.yellow,fontSize:16,fontWeight:800}}>{"✓"}</span>:null}
              </button>;
            })}
          </div>}
        </div>
  ...
  if(subPage==="pais") return (
    <div style={{position:"fixed",inset:0,zIndex:400,background:C.bg,maxWidth:480,margin:"0 auto",overflowY:"auto"}}>
      ...
      <div style={{position:"sticky",top:0,background:C.card,borderBottom:"1px solid "+C.border,padding:"14px 20px",display:"flex",alignItems:"center",gap:14}}>
        <button onClick={function(){setSubPage(null);}} style={{background:C.bg,border:"none",borderRadius:9999,width:34,height:34,cursor:"pointer",color:C.blue,fontSize:18,display:"flex",alignItems:"center",justifyContent:"center"}}>{"<-"}</button>
        <div style={{fontSize:18,fontFamily:"'Syne',sans-serif",color:C.text,fontWeight:700}}>{currentLang==="en"?"Change Country":"Cambiar Pais"}</div>
      </div>
      <div style={{padding:"12px 16px 40px"}}>
        {CITIES.map(function(c){
          var isSelected=c.id===userCity;
          return (
            <button key={c.id} onClick={function(){
              var uid=(function(){ try{var s=localStorage.getItem("epale_session"); var d=s?JSON.parse(s):null; return d&&d.uid?d.uid:"";}catch(e){return "";} })();
              if(uid) api.updateProfile(uid,props.userName,c.id,props.userName.toLowerCase().replace(/\s/g,""),props.userPhoto,props.userBio).catch(function(){});
              try{ var s=localStorage.getItem("epale_session"); var d=s?JSON.parse(s):{}; d.city=c.id; localStorage.setItem("epale_session",JSON.stringify(d)); }catch(e){}
              if(props.onCityChange) props.onCityChange(c.id);
              setSubPage(null);
            }} style={{width:"100%",display:"flex",alignItems:"center",gap:14,padding:"14px 16px",background:isSelected?C.bg:C.card,border:"2px solid "+(isSelected?C.yellow:C.border),borderRadius:14,cursor:"pointer",textAlign:"left",marginBottom:8}}>
              <span style={{fontSize:28}}>{toFlag(CITY_FLAGS[c.id])}</span>
              <div style={{flex:1}}>
                <div style={{fontSize:15,fontFamily:"'Syne',sans-serif",color:C.text,fontWeight:700}}>{c.name}</div>
                <div style={{fontSize:11,color:C.muted,fontFamily:"'Inter',sans-serif"}}>{c.pop}</div>
              </div>
              {isSelected?<div style={{width:22,height:22,borderRadius:9999,background:C.yellow,display:"flex",alignItems:"center",justifyContent:"center",fontSize:13}}>{"✓"}</div>:null}
            </button>
          );
        })}
      </div>
...
function AuthStep4(props) {
  ...
  var finish=function(){ setLoading(true); setError(""); api.signUp(email,password,userName,chosenCity,userName.toLowerCase().replace(/\s/g,"")).then(function(res){ if(res.error&&res.error!=="User already registered"){ setError(res.error_description||res.msg||res.error||"Error al crear cuenta"); setLoading(false); return; } var token=(res.session&&res.session.access_token)||res.access_token||""; var uid=(res.user&&res.user.id)||(res.session&&res.session.user&&res.session.user.id)||""; var refresh=(res.session&&res.session.refresh_token)||res.refresh_token||""; if(token){ window._supaToken=token; if(uid){
                api.upsertProfile(uid,userName,chosenCity,userName.toLowerCase().replace(/\s/g,""));
                // Send welcome notification
                api.addNotification(uid,"Epale","welcome",0).catch(function(){});
              }
              setLoading(false); try { localStorage.setItem("epale_session",JSON.stringify({city:chosenCity,name:userName,photo:userPhoto,token:token,uid:uid,refresh:refresh})); } catch(e){} onDone(chosenCity,userName,userPhoto,token,uid); } else { setLoading(false); setSent(true); } }).catch(function(){ setError("Error de conexion"); setLoading(false); }); };
            ...
            <div key={i} style={{display:"flex",alignItems:"center",gap:14,padding:"14px 20px",borderBottom:"1px solid "+C.border,background:C.card}}>
              ...
              <div style={{flex:1,minWidth:0}}>
                <div style={{display:"flex",alignItems:"center",gap:4}}>
                  ...
                  {isFounder(uName)?<span style={{display:"inline-flex",alignItems:"center",gap:3,background:"linear-gradient(135deg,#ffd700,#ff8c00)",borderRadius:20,padding:"1px 7px",fontSize:10,fontWeight:800,color:"#fff"}}>{"⚡"} Founder</span>:isVerified(uName)?<span style={{display:"inline-flex",alignItems:"center",justifyContent:"center",width:16,height:16,background:C.blue,borderRadius:9999,fontSize:10,color:"#fff",fontWeight:800}}>{"✓"}</span>:null}
                </div>
...
function Pana(props) {
  ...
  var speak=function(text){
    fetch("https://api.elevenlabs.io/v1/text-to-speech/Aoh8oiCIlPke1wFxeNuK/stream",{
      method:"POST",
